...
#define STRING_CONFIG_H_AUTHOR "(PCMaik, SOVOL SV01)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "SOVOL SV01 PCMAIK"
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -20, -20, -0.54 }
